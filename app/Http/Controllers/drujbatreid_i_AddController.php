...
use App\drujbatreid_i;
use Validator;
class drujbatreid_i_AddController extends Controller
{
    public function execute(Request $request){
				...
				if($request->isMethod('post')){
					...
					if($validator->fails()){
							return redirect('admin/drujbatreid_i')->with('status','Ошибка :C		
