...
class vhods_allController extends Controller
{
...
$allItems22 = new \Illuminate\Database\Eloquent\Collection;//Создаем пустую коллекцию
//обьединение коллекции
...
//$users = DB::table('laranvikapital_vs','ritailscapital_vs')->get();
//dd($menu);
...
//перебор коллекции
    	...
    	return view('site.vhods_all', array(
		'ishod_spis'=>$menu2,
		'vhod_spis'=>$menu ));
    }
}
