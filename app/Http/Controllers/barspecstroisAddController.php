...
use App\barspecstroi_v;
use Validator;
class barspecstroisAddController extends Controller
{
     public function execute(Request $request){
				...
				if($request->isMethod('post')){
					...
					if($validator->fails()){
						return redirect('admin/barspecstrois')->with('status','Ошибка :C		
