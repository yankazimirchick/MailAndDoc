...
use App\laranvikapital_i;

use Validator;
class laranvikapital_i_AddController extends Controller
{
	...
	public function execute(Request $request){
				...
				if($request->isMethod('post')){
					...
					if($validator->fails()){
						return redirect('admin/laranvikapitals_i')->with('status','Ошибка :C		
