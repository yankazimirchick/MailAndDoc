...
use App\ritailscapital_i;
use Validator;

class ritailscapitals_i_AddController extends Controller
{
    public function execute(Request $request){
				...
				if($request->isMethod('post')){
					...
					if($validator->fails()){
						return redirect('admin/ritailscapitals_i')->with('status','Ошибка :C		
